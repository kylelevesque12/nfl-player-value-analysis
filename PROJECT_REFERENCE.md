...
> - **Skill score:** the headline, *how much better is the model than a strong
...
**Scope:** this is a tiering projection, not a finished ranking system. It does
...
- **Opponent:** how many PPR points this week's defense typically allows to the position, a rough "is this a good matchup?" signal.
...
season's actual results. **Scope is clear:** the free data ends in 2021, so this says
...
actual-result column is removed entirely. The one one approximation: recent-form numbers
...
**Verdict: a real but modest effect, and genuinely underpowered**, a fraction of a
