...
| Headline model: two-stage value | [Two-stage value model](report/two_stage_value.md) |
...
3. See the [two-stage value model](report/two_stage_value.md), the project's headline contribution, including its role-driven vs efficiency-driven intervals.
4. Check the [model benchmark](report/model_benchmark.md) for how the models are evaluated honestly against strong baselines.
5. Open the [2026 Excel report](outputs/tables/2026_player_value_predictions.xlsx) and read the [salary-efficiency findings](report/salary_efficiency_findings.md).
